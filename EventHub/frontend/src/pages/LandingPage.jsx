...
const LandingPage = () => {
  ...
  return (
    <div className="w-full h-[calc(100vh-4rem)] overflow-y-auto snap-y snap-mandatory scroll-smooth relative z-10">
      ...
      {/* About Section - Tailored Portal (Page 3) */}
      <motion.section 
        className="w-full min-h-[calc(100vh-4rem)] snap-start snap-always flex flex-col justify-center relative z-10 border-t border-white/5"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true, margin: "-100px" }}
        variants={scrollRevealVariants}
      ...
      {/* Featured Categories Section (Page 4) */}
      <motion.section 
        className="w-full min-h-[calc(100vh-4rem)] snap-start snap-always flex flex-col justify-center relative z-10 px-4 sm:px-6 lg:px-12 py-16 border-t border-white/5"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true, margin: "-100px" }}
        variants={scrollRevealVariants}
      ...
      {/* About Section - Stats & Vision (Page 5) */}
      <motion.section 
        className="w-full min-h-[calc(100vh-4rem)] snap-start snap-always flex flex-col justify-center relative z-10 border-t border-white/5"
        initial="hidden"
        whileInView="visible"
