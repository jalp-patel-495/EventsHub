...
from .views import VenueViewSet, VenueBookingCreateListView, VenueBookingActionView, PollPaymentView, ApprovePaymentView, VenueReviewCreateView, VenueBookingMessageView
...
urlpatterns = [
    ...
    path('bookings/<int:booking_id>/messages/', VenueBookingMessageView.as_view(), name='venue_booking_messages'),
